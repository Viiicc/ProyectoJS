...
function generarHtmlProducto(producto) {
  var html = `<div class="col-sm col-md-6 col-xl-3 bot1">
    <img src="${producto.imagen}" height="300" width="180">
...
function agregarProducto() {
  ...
  if (cantidad > 0) {
    $("#error").html("");
    var itemId = parseInt($("#comidas").val());
